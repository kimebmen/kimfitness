...
stripe.api_key = 'sk_test_51H8MlqA0ZUlrJGDiyVqZMxNgZbP3dygkm8Q1eOWmvByj4CEhQK7UWRuf6NOksepaLgFWHzs0dLMhoTLXRR4K4BSI00uhAjeWKJ'
...
def checkout(request):
	...
	if request.method == 'POST':
		...
		plan = 'price_1H8MzsA0ZUlrJGDikW7pWnTu'
		if request.POST['plan'] == 'yearly':
			plan = 'price_1H8N3BA0ZUlrJGDiS5FYqnNX'
